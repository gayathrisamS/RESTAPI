...
public class GayathriVillage {
    ...
    public GayathriVillage(){}
    public GayathriVillage(int villageId, String villageName, int numOfMen, int numOfWomen, int villagePopulation,
            int numOfSchools) {
