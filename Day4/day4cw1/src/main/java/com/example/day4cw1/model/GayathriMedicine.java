package com.example.day4cw1.model;

import jakarta.persistence.Entity;
import jakarta.persistence.Id;

@Entity
public class GayathriMedicine {
    @Id
    ...
    public GayathriMedicine() {
    }
    public GayathriMedicine(int medicineId, String medicineName, String medicineFor, String medicineBrand,
