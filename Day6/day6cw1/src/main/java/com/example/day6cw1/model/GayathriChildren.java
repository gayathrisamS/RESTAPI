...
public class GayathriChildren {
    ...
    public GayathriChildren() {
    }
    public GayathriChildren(int babyId, String babyFirstName, String babyLastName, String fatherName, String motherName,
            String address) {
        this.babyId = babyId;
